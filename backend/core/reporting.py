...
class PDFReportGenerator:
    ...
    def generate_dispute_letter(self, data: Dict[str, Any]) -> bytes:
        ...
        I was a victim of a <b>{data.get('scam_type', 'Digital Fraud')}</b> identified by the Sentinel 1930 Anti-Scam Grid.<br/><br/>
        <b>Transaction Details:</b><br/>
        - Transaction ID: {data.get('txn_id', 'N/A')}<br/>
        - Date/Time: {data.get('txn_date', 'N/A')}<br/>
        - Sentinel Case ID: {data.get('case_id', 'BASIG-' + uuid.uuid4().hex[:6].upper())}<br/><br/>
        ...
        Enclosed is the Forensic Digital FIR packet generated by the Sentinel nodes.
        """
    ...
    def generate_ombudsman_complaint(self, data: dict) -> bytes:
        ...
        The Sentinel 1930 system has flagged this transaction as a high-probability fraudulent 
    ...
    def generate_npci_grievance(self, data: dict) -> bytes:
        ...
        Dear Team,<br/><br/>
        I am reporting a fraudulent UPI transaction. The Sentinel 1930 system has identified 
        ...
        """
        elements.append(Paragraph(body, styles['Normal']))
        elements.append(Paragraph("<br/><br/>Regards,<br/>[Sentinel Automated Dispatch]", styles['Normal']))
